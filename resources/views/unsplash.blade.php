<div>
    <div wire:key="images-finder">
        ...
        @if (count($photos))
            ...
            <div class="mt-4 flex justify-center items-center space-x-2">
                <div wire:key="previous-button">
                    @if ($page > 1)
                        <x-library::button.secondary wire:click="previousPage">
                ...
                <div wire:key="next-button">
                    @if ($page < $totalPages)
                        <x-library::button.secondary wire:click="nextPage">
        ...
        @elseif ($keyword && !count($photos))
            <div class="px-8 pt-6 text-center text-gray-500 text-lg">Oops! There are no images match your keyword.</div>
        @endif
    </div>
</div>
